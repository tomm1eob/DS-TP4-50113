...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Factura factMod = entityManager.find(Factura.class, 1L); // Buscamos factura
            factMod.setNumero(19);
            entityManager.merge(factMod); // Actualiza
        ...
        } finally {// Cerrar el EntityManager y el EntityManagerFactory
        entityManager.close();
